...
function Dashboard() {
  ...
  const addLink = async () => {
    const res = await fetch("https://linktree-frontend-one.vercel.app/api/user/me/links", {
      method: "POST",
      headers: {
  ...
  const deleteLink = async (id) => {
    const res = await fetch(`https://linktree-frontend-one.vercel.app/api/user/me/links/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token")
      }
  ...
  const updateLink = async () => {
    const res = await fetch(`https://linktree-frontend-one.vercel.app/api/user/me/links/${editingLink._id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("token")
  ...
  const handleProfileReset = async () => {
    const res = await fetch("https://linktree-frontend-one.vercel.app/api/user/me/reset", {
      method: "PUT",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token")
      }
